...
// Ten plik zawiera definicje kolorów używanych w aplikacji.
// Kolory są zdefiniowane osobno dla motywu jasnego (light) i ciemnego (dark).
// Zostały wygenerowane przez narzędzie Material Theme Builder.
...
val md_theme_light_tertiaryContainer = Color(0xFFFED7F6)
val md_theme_light_onTertiaryContainer = Color(0xFF2D122A)
...
val md_theme_dark_primaryContainer = Color(0xFF2A3C9F)
...
val md_theme_dark_onTertiary = Color(0xFF442740)
val md_theme_dark_tertiaryContainer = Color(0xFF5D3D57)
val md_theme_dark_onTertiaryContainer = Color(0xFFFED7F6)
